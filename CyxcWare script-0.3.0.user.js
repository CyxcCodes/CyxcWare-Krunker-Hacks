...
<div class="dialog">${shouldShowAd ? `<big>Loading ad... (mb cuz)</big>` : `<div class="close" onclick="this.parentNode.style.display='none';"></div>
	<big>== Actual gay ass hacks ==</big>
	<br>
    <br>
	[Hello] CyxcWare was developed by JP
	<br>
	<br>
	[B] to toggle aimbot
	<br>
	...
	<br>
	<br>
	CyxcWare Alpha v4.921
	<br>
	<br>
	<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 5px;">
		<div class="btn" onclick="window.open('https://github.com/CyxcCodes', '_blank')">CyxcCodes Offical</div>
	</div>
	` }
</div>`;
...
function createGUI() {
	...
	contentEl.appendChild( fromHtml( `<div class="zui-item text">
		<span>Created by JP, CyxcWare Corp. (playtester: Finn, indian gang)</span>
	</div>` ) );
